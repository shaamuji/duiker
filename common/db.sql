...
-- ============ CREATION OF THE TABLE pm_coupon_user ============
...
ALTER TABLE pm_coupon_user ADD CONSTRAINT coupon_user_fkey FOREIGN KEY (id_coupon) REFERENCES pm_coupon(id) ON DELETE CASCADE ON UPDATE NO ACTION;
