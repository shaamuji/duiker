...
<head>
    ...
    <title><?php echo PMS_SITE_TITLE; ?></title>
    ...
    <link rel="stylesheet" href="<?php echo DOCBASE; ?>templates/<?php echo PMS_TEMPLATE; ?>/css/layout.css">
    <link rel="stylesheet" href="<?php echo DOCBASE; ?>templates/<?php echo PMS_TEMPLATE; ?>/css/colors.css" id="colors">
    <link rel="stylesheet" href="<?php echo DOCBASE; ?>templates/<?php echo PMS_TEMPLATE; ?>/css/custom.css">
...
<body id="page-maintenance" itemscope itemtype="http://schema.org/WebPage"<?php if(PMS_RTL_DIR) echo " dir=\"rtl\""; ?>>
<div class="container">
    <div class="row">
        <div class="col-sm-6"></div>
        <div class="col-sm-6">
            <div class="maintenance-msg">
                <?php echo stripslashes(PMS_MAINTENANCE_MSG); ?>
            </div>
        </div>
    </div>
</div>
